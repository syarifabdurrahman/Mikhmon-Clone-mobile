...
class VoucherPrinter {
  ...
  static Future<String> generateHtml(
    ...
    final qrPng = await _generateQrPng(voucher.qrData, size: 300);
...
<body>
    <div class="voucher-container">
        <hr class="cut-line cut-line-top">
        ...
        <div class="qr-container">
            <img class="qr-code" src="data:image/png;base64,$qrBase64" alt="QR Code" width="200" height="200">
        </div>
        ...
        <hr class="cut-line cut-line-bottom">
    </div>
</body>
</html>
''');
    ...
    for (final voucher in vouchers) {
      ...
      html.writeln('''
        <div class="voucher-card">
            <div class="cut-indicator">✂️ CUT HERE ✂️</div>
            ...
            <div class="qr-section">
                <img class="qr-image" src="data:image/png;base64,$qrBase64" alt="QR" width="120" height="120">
            </div>
